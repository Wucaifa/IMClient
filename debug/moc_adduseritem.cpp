...
struct qt_meta_stringdata_AddUserItem_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_AddUserItem_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_AddUserItem_t qt_meta_stringdata_AddUserItem = {
    {
QT_MOC_LITERAL(0, 0, 11) // "AddUserItem"
...
static const uint qt_meta_data_AddUserItem[] = {
...
QT_INIT_METAOBJECT const QMetaObject AddUserItem::staticMetaObject = { {
    QMetaObject::SuperData::link<ListItemBase::staticMetaObject>(),
    qt_meta_stringdata_AddUserItem.data,
    qt_meta_data_AddUserItem,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *AddUserItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AddUserItem.stringdata0))
