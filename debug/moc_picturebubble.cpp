...
struct qt_meta_stringdata_PictureBubble_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PictureBubble_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PictureBubble_t qt_meta_stringdata_PictureBubble = {
    {
QT_MOC_LITERAL(0, 0, 13) // "PictureBubble"
...
static const uint qt_meta_data_PictureBubble[] = {
...
QT_INIT_METAOBJECT const QMetaObject PictureBubble::staticMetaObject = { {
    QMetaObject::SuperData::link<BubbleFrame::staticMetaObject>(),
    qt_meta_stringdata_PictureBubble.data,
    qt_meta_data_PictureBubble,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PictureBubble::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PictureBubble.stringdata0))
