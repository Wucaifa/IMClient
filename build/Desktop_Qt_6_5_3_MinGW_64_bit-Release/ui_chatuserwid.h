...
public:
    ...
    void setupUi(QWidget *ChatUserWid)
    {
        ...
        ChatUserWid->resize(400, 94);
        ChatUserWid->setMinimumSize(QSize(0, 75));
        ChatUserWid->setMaximumSize(QSize(16777215, 94));
        gridLayout = new QGridLayout(ChatUserWid);
        ...
        gridLayout->addWidget(icon_wid, 0, 0, 1, 1);
        ...
        gridLayout->addWidget(user_info_wid, 0, 1, 1, 1);
        ...
        gridLayout->addWidget(time_wid, 0, 2, 1, 1);
