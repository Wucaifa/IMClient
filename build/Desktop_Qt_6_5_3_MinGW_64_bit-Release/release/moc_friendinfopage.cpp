...
static constexpr auto qt_meta_stringdata_CLASSFriendInfoPageENDCLASS = QtMocHelpers::stringData(
    "FriendInfoPage",
    "sig_jump_chat_item",
    "",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSFriendInfoPageENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSFriendInfoPageENDCLASS_t qt_meta_stringdata_CLASSFriendInfoPageENDCLASS = {
    {
        QT_MOC_LITERAL(0, 14),  // "FriendInfoPage"
        QT_MOC_LITERAL(15, 18),  // "sig_jump_chat_item"
        QT_MOC_LITERAL(34, 0),  // ""
        QT_MOC_LITERAL(35, 25),  // "std::shared_ptr<UserInfo>"
        QT_MOC_LITERAL(61, 2),  // "si"
        QT_MOC_LITERAL(64, 19)   // "on_msg_chat_clicked"
    },
    "FriendInfoPage",
    "sig_jump_chat_item",
    "",
