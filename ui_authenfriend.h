...
public:
    ...
    void setupUi(QDialog *AuthenFriend)
    {
        ...
        AuthenFriend->resize(360, 620);
        AuthenFriend->setMinimumSize(QSize(360, 620));
        AuthenFriend->setMaximumSize(QSize(360, 620));
        gridLayout = new QGridLayout(AuthenFriend);
        ...
        scrollcontent->setGeometry(QRect(0, 0, 341, 481));
        ...
        gridLayout->addWidget(apply_sure_wid, 2, 0, 1, 1);
