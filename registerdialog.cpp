    ...
    ui(new Ui::RegisterDialog)
{
    ...
    connect(ui->verification_code_btn, &QPushButton::clicked, this, &RegisterDialog::on_get_code_clicked);
    ...
    connect(ui->verification_code_edit, &QLineEdit::editingFinished, this, [this](){
            checkVarifyValid();
    });
...
//    json_obj["passwd"] = hashString(ui->pass_edit->text());
...
//    json_obj["confirm"] = hashString(ui->confirm_edit->text());
    json_obj["confirm"] = ui->confirm_edit->text();
    json_obj["varifycode"] = ui->verification_code_edit->text();
...
{
    auto pass = ui->verification_code_edit->text();
    if(pass.isEmpty()){
...
void RegisterDialog::on_verification_code_btn_clicked()
{
