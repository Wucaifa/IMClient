...
public:
    ...
    void setupUi(QDialog *FindFailDlg)
    {
        ...
        FindFailDlg->setMinimumSize(QSize(260, 160));
        FindFailDlg->setMaximumSize(QSize(260, 160));
        gridLayout = new QGridLayout(FindFailDlg);
        ...
        gridLayout->addWidget(fail_tip, 1, 0, 1, 1);
        ...
        gridLayout->addWidget(fail_tip2, 2, 0, 1, 1);
