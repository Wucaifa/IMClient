...
public:
    ...
    void setupUi(QDialog *RegisterDialog)
    {
        ...
        verification_code_label->setObjectName(QString::fromUtf8("verification_code_label"));
        ...
        verification_code_edit->setObjectName(QString::fromUtf8("verification_code_edit"));

        horizontalLayout_5->addWidget(verification_code_edit);

        verification_code_btn = new TimerBtn(page);
        verification_code_btn->setObjectName(QString::fromUtf8("verification_code_btn"));
